...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self = [self initWithFrame:CGRectZero decoder:nil];
...
- (void)kx_render: (KxVideoFrame *) frame
{        
...
- (KxVideoFrame *) handleVideoFrame:(JDCAVFrame *)jdframe
{
    AVFrame *_videoFrame = jdframe.avFrame;
    AVCodecContext *_videoCodecCtx = jdframe.mCtx->codecCtxVideo;
