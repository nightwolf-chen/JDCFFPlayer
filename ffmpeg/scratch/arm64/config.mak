...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch arm64 -mios-version-min=6.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=6.0 -fembed-bitcode' --prefix=/Users/Jidong/Documents/projects/JDCMediaPlayer/ffmpeg/thin/arm64
prefix=/Users/Jidong/Documents/projects/JDCMediaPlayer/ffmpeg/thin/arm64
